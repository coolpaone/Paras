...
export default function About() {
  ...
  return (
    <section className="py-20 bg-slate-900 border-y border-slate-800/80" id="statement">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-8 bg-slate-950/90 border border-slate-800 p-8 sm:p-10 rounded-2xl relative shadow-md flex flex-col justify-between"
          >
