...
import { User, Mail, MapPin, Home, Send, Check, Copy, CheckCircle2, Globe, ExternalLink } from 'lucide-react';
    ...
    <section className="py-24 bg-slate-900 border-t border-slate-800 relative" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* Left Column: Contact Cards Stack - Perfectly matching height */}
          <motion.div
          ...
          >
            {/* Profile Name Card */}
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 flex items-center gap-4 transition-all hover:border-slate-700 shadow-sm">
            ...
            {/* Send Email Card */}
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 hover:border-sky-500 transition-colors group flex items-center justify-between shadow-sm">
              <a
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-white font-semibold text-sm sm:text-base group-hover:text-sky-300 transition-colors">
                    Send Email
                  </div>
                </div>
              </a>
              <a
                href={`mailto:${profileData.email}`}
                className="px-3 py-1.5 rounded-lg bg-sky-600/20 text-sky-400 border border-sky-500/30 hover:bg-sky-600 hover:text-white transition-colors text-xs font-semibold flex items-center gap-1.5 cursor-pointer ml-2"
              >
            ...
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 hover:border-sky-500 transition-colors group flex items-center justify-between shadow-sm">
              ...
              <button
                ...
                className="p-2 rounded-lg bg-slate-900 text-slate-400 hover:text-white hover:bg-slate-800 transition-colors ml-2 cursor-pointer"
            ...
            <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 flex items-center gap-4 transition-all hover:border-slate-700 shadow-sm">
              ...
              <div>
                <div className="text-xs uppercase font-semibold text-slate-400">Current Address</div>
