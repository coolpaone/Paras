...
export const profileData: ProfileData = {
  ...
  photos: [
    {
      id: 'photo-formal-id',
      url: '/paras-original-avatar.jpg',
      title: 'Professional Security Identity & Formal Portrait',
      ...
      locationTag: 'Sonapur / Dubai, UAE',
      featured: true,
    },
    {
      id: 'photo-retail-uniform',
      url: '/images/Paras-1.jpg',
    ...
    },
    {
      ...
      url: '/images/Paras.png',
      title: 'Executive Security & Formal Suite Portrait',
      category: 'Executive Security',
      description: 'Executive security portrait in dark formal business suit with crimson silk necktie.',
      locationTag: 'UAE',
      featured: false,
    },
  ],
